"""
A Light-weight Dataset Reader for Universal Dependencies, with support for multiword tokens and special handling for NULL "_" tokens
"""
...
@DatasetReader.register("udify_lightweight_universal_dependencies")
